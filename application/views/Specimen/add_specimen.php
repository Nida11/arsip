...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/logoarsip.png') ?>">
    <title>
       TAMBAH SPECIMEN
    </title>
    <!-- Fonts and icons -->
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://39ed-123-231-234-58.ngrok-free.app/arsip/index.php/Guest/beranda_admin " target="_blank">
                <img src="<?= base_url('assets/img/semar.png') ?>" width="26px" height="26px" class="navbar-brand-img h-100" alt="main_logo">
