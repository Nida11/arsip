...
<head>
  ...
  <title>SIMAK | Registration Page</title>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?php echo base_url()."index.php/Guest/entry_akun";?>" method="post">
        ...
        <div class="input-group mb-3">
			<label for="psw"></label>
         <input type="password" id="psw" name="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" required>
          <div class="input-group-append">
            <div class="input-group-text">
