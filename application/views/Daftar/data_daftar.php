...
.daftar-arsip-section {
  background: #f8f9fa;   /* abu2 tipis */
  padding: 1rem 1.5rem;  /* jarak dalam */
  border-radius: 8px;    /* sudut melengkung */
  margin-bottom: 1rem;   /* jarak antar elemen bawah */
}
...
#addSlotModal .modal-dialog {
  ...
  width: 55%;         /* biar responsive */
  margin: auto;       /* pastikan tetap center */
  display: flex;
   align-items: center;       /* center vertical */
  justify-content: center;   /* ✅ center horizontal */
  min-height: 100vh;  /* biar modal ketengah vertical */
  
}

/* Atur tinggi/isi modal supaya lebih lega */
#addSlotModal .modal-body {
  max-height: 80vh;   /* biar gak terlalu panjang keluar layar */
  overflow-y: auto;   /* kasih scroll kalau isinya kepanjangan */
  padding: 2rem;      /* jarak dalam lebih rapi */
}
...
<div class="modal fade" id="addSlotModal" tabindex="-1" aria-labelledby="addSlotModalLabel" aria-hidden="true">
  ...
  <div class="form-check form-check-inline">
    <input class="form-check-input" type="radio" name="is_multiple" id="" value="0" checked>
    <label class="form-check-label" for="single"> Arsip Inaktif</label>
  </div>
  <div class="form-check form-check-inline">
    <input class="form-check-input" type="radio" name="is_multiple" id="" value="1">
...
<div id="info-nomor-surat" class="alert custom-alert d-none"></div>
     ...
     $nama_jenis = $this->db->get('jenis_surat')->result();
      ...
      <div class="col-md-6 mb-3">
        <label class="form-control-label" for="bidang">Asal Arsip / Unit Kerja</label>
      ...
      <div class="col-md-6 mb-3">
        <label class="form-control-label" for="nomor_surat">Lokasi simpan</label>
